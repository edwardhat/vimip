...
def main():
    ...
    while True:
        ...
        points1 = (getRect(40,499)).T
        points1 = (Tmat(700,500) @ H(points1)).T[:,:2]
        points2 = (getRect(30,300)).T
        points3 = (getRect(30,300)).T
        points4 = (getRect(30,300)).T
        points5 = (getRect(30,300)).T
        points6 = (getRect(30,300)).T
        points2 = (Tmat(700,500) @ Rmat(theta) @ H(points3)).T[:,:2]
        points3 = (Tmat(700,500) @ Rmat(72+theta) @ H(points3)).T[:,:2]
        points4 = (Tmat(700,500) @ Rmat(144+theta) @ H(points4)).T[:,:2]
        points5 = (Tmat(700,500) @ Rmat(216+theta) @ H(points5)).T[:,:2]
        points6 = (Tmat(700,500) @ Rmat(288+theta) @ H(points6)).T[:,:2]
        ...
        drawPolygon(canvas, points4, (255,255,255))
        drawPolygon(canvas, points5, (255,255,255))
        drawPolygon(canvas, points6, (255,255,255))
